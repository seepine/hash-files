...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const workdir = utils.getInput(constants_1.Inputs.Workdir, { required: true });
            ...
            const contents = yield Promise.all(reads);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.hashHex = exports.getInputAsBool = exports.getInputAsInt = exports.getInputAsArray = exports.getInput = void 0;
const core = __importStar(__nccwpck_require__(186));
